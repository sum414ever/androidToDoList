package com.architecture_example.androidtodolist.adapter;
...
import com.architecture_example.androidtodolist.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteHolder> {
    ...
    class NoteHolder extends RecyclerView.ViewHolder{
        ...
        public NoteHolder(@NonNull View itemView) {
            super(itemView);
            textViewTitle = itemView.findViewById(R.id.tv_view_title);
